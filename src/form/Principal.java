...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/IMG2.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtMateria, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtJustif, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            String materia = (String) TablaDatos.getValueAt(row, 1);
            String justif = (String) TablaDatos.getValueAt(row, 2);
            txtId.setText("" + id);
            txtMateria.setText(materia);
            txtJustif.setText(justif);
...
//            model=new DefaultTableModel(null,Titulos);   
            ...
            while (rs.next()) {
                ...
                persona[1] = rs.getString("Materia");
                persona[2] = rs.getString("Justif");
    ...
    void Agregar() {
        ...
        String justif = txtJustif.getText();
        try {
            if (materia.equals("") || justif.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
            } else {
                String sql = "insert into persona(Materia,Justif) values('" + materia + "','" + justif + "')";
                con = cn.getConnection();
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Solicitud Generada Con Exito");
                limpiarTabla(model);
    ...
    void Modificar() {
        String materia = txtMateria.getText();
        String justif = txtJustif.getText();
        String sql = "update persona set MATERIA='" + materia + "',Justif='" + justif + "' where Id=" + id;
        try {
            if (materia != null || justif != null) {
                con = cn.getConnection();
                st = con.createStatement();
                st.executeUpdate(sql);
